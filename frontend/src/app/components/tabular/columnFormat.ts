...
export const FORMAT_OPTIONS: Array<{ value: ColumnFormat; label: string; icon: LucideIcon; iconClassName: string }> = [
    { value: "text",            label: "Texte libre",       icon: AlignLeft,  iconClassName: "text-sky-500"     },
    { value: "bulleted_list",   label: "Liste à puces",     icon: List,       iconClassName: "text-indigo-500"  },
    { value: "number",          label: "Nombre",            icon: Hash,       iconClassName: "text-violet-500"  },
    { value: "percentage",      label: "Pourcentage",       icon: Percent,    iconClassName: "text-fuchsia-500" },
    { value: "monetary_amount", label: "Montant monétaire", icon: Banknote,   iconClassName: "text-emerald-600" },
    { value: "currency",        label: "Devise",            icon: DollarSign, iconClassName: "text-teal-600"    },
    { value: "yes_no",          label: "Oui / Non",         icon: ToggleLeft, iconClassName: "text-amber-500"   },
...
export function formatLabel(format: ColumnFormat): string {
    return FORMAT_OPTIONS.find((o) => o.value === format)?.label ?? "Texte";
}
